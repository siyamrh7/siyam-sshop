                                            ...
                                            <ul className="product_color">
                                                <li>
                                                    ...
                                                    <ul className="color_list">
                                                        <li>
                                                            <div className="color_mark" style={{ background: "#999999" }}></div>
                                                        </li>
                                                        <li>
                                                            <div className="color_mark" style={{ background: "#b19c83" }}></div>
                                                        </li>
                                                        <li>
                                                            <div className="color_mark" style={{ background: "#000000" }}></div>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
