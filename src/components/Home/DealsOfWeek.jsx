                                    ...
                                    <div className="product_panel panel active">
                                        <div className="featured_slider slider">
                                            ...
                                            <div className="featured_slider_item">
                                                ...
                                                <div className="product_items discount d-flex flex-column align-items-center justify-content-center text-center">
                                                    ...
                                                    <div className="product_content">
                                                        ...
                                                        <div className="product_extras">
                                                            <div className="product_colors">
                                                                <input type="radio" defaultChecked name="product_colors" style={{ background: "#b19c83" }} />
                                                                <input type="radio" name="product_colors" style={{ background: "#000000" }} />
                                                                <input type="radio" name="product_colors" style={{ background: "#999999" }} />
                                                            </div>
                                                            <button className="product_cart_buttons">Add to Cart</button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="featured_slider_item">
                                                <div className="border_active"></div>
                                                <div className="product_items is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                    ...
                                                    <div className="product_content">
                                                        ...
                                                        <div className="product_extras">
                                                            ...
                                                            <button className="product_cart_buttons active">Add to Cart</button>
                                                        </div>
                                                    </div>
                                                    <div className="product_fav"><i className="fas fa-heart"></i></div>
                                                    <ul className="product_marks">
                                            ...
                                            <div className="featured_slider_item">
                                                <div className="border_active"></div>
                                                <div className="product_items d-flex flex-column align-items-center justify-content-center text-center">
